...
Route::group(['as' => 'backend::', 'namespace' => 'Backend', 'middleware' => 'auth', 'prefix' => 'admin'], function () {
    ...
    Route::get('data_penduduk', ['as' => 'data_penduduk.index', 'middleware' => 'access:index,admin/data_penduduk', 'uses' => 'DataPenduduksController@index']);
    Route::get('data_penduduk/datatables', ['as' => 'data_penduduk.datatables', 'middleware' => 'access:index,admin/data_penduduk', 'uses' => 'DataPenduduksController@datatables']);
    Route::get('data_penduduk/create', ['as' => 'data_penduduk.create', 'middleware' => 'access:create,admin/data_penduduk', 'uses' => 'DataPenduduksController@create']);
    Route::post('data_penduduk/create', ['as' => 'data_penduduk.store', 'middleware' => 'access:create,admin/data_penduduk', 'uses' => 'DataPenduduksController@store']);

    # PelayananSuratController
    Route::get('pelayanan_surat', ['as' => 'pelayanan_surat.index', 'middleware' => 'access:index,admin/pelayanan_surat', 'uses' => 'PelayananSuratsController@index']);
    Route::get('pelayanan_surat/datatables', ['as' => 'pelayanan_surat.datatables', 'middleware' => 'access:index,admin/pelayanan_surat', 'uses' => 'PelayananSuratsController@datatables']);
});
