...
<!-- Themes -->
<link rel="stylesheet" type="text/css" href="{{ asset('themes/AdminLTE/2.3.7/css/AdminLTE.min.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('themes/AdminLTE/2.3.7/css/skins/_all-skins.min.css') }}">
